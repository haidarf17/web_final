...
$sql = "SELECT id, movie, description, image_path, old_price, price, genre FROM tbl_movies WHERE is_active = 1";
if (!empty($genreFilter)) {
    $sql .= " AND genre LIKE '%" . $conn->real_escape_string($genreFilter) . "%'";
}
